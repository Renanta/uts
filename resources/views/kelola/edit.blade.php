        ...
        <div class="card">
            ...
            <div class="header pt-3 grey lighten-2">
                ...
                <div class="row d-flex justify-content-start">
                    <h3 class="deep-grey-text mt-3 mb-4 pb-1 mx-5">Sunting Artikel</h3>
                </div>
            ...
            <div class="card-body mx-4 mt-4">
                ...
                <!--Body-->
                <form action="{{ route('kelola.update', $id) }}" class="md-form" method="POST" enctype="multipart/form-data">
                    @method('PUT')
                    @csrf
                    <div class="md-form">
                    ...
                    <div class="md-form pb-3">
                        ...
                        <textarea name="content" id="content" cols="30" rows="10" class="form-control">{{ $artikel -> content}}</textarea>
                    </div>
                    <div class="md-form pb-3">
                        <label for="image">Ganti Gambar</label>
                        <input type="file" id="image" name="image" class="form-control">
                        <img src="{{asset('storage/img/'.$artikel->image)}}" class="img-fluid pt-3" style="width: 200px; height:200px;">
                    </div>
                    <div class="mb-4">
